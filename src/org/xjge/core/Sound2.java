...
final class Sound2 {
    ...
    static Sound2 placeholder = new Sound2("/org/xjge/assets/", "xjge_sound_beep.ogg");
    
    Sound2(String filepath, String filename) {
    ...
    int[] loadSound(String filepath, String filename) {
        try(InputStream file = Sound2.class.getResourceAsStream(filepath + filename)) {
            int[] info = new int[4];
