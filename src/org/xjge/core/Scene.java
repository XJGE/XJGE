...
public abstract class Scene {
     ...
     *               being rendered
     */
    void render(Map<String, Shader> glPrograms, int viewportID, Camera camera) {
     ...
     */
    public abstract void render(Map<String, Shader> glPrograms, int viewportID, Camera camera, int depthTexHandle);
