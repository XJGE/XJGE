...
public abstract class Scene {
     ...
     *               being rendered
     */
    void render(int viewportID, Camera camera) {
        if(shadowMap != null) render(viewportID, camera, shadowMap.depthTexHandle);
        else                  render(viewportID, camera, -1);
    }
     ...
     */
    public abstract void render(int viewportID, Camera camera, int depthTexHandle);
     ...
     *                     be used to generate the shadow map texture
     */
    public abstract void renderShadows(Shader depthProgram);
