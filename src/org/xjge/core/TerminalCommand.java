...
public abstract class TerminalCommand {
    ...
    /**
     * Obtains the output object generated by the command that will be 
     * displayed to the user after it is executed.
     * 
     * @return an object that can be used by the terminal to format command 
     *         output information
     */
