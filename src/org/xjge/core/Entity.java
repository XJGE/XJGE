...
/**
 * Abstract class used to represent dynamic objects in the game world.
 * 
 * @author J Hoffman
 * @since  2.0.0
 */
public abstract class Entity {
     ...
     * @param lights an array of light source objects provided by the current scene
     ...
     * necessary) by passing them as uniforms to the depth shader program.
     * 
     ...
     * needed.
     * <p>
     * NOTE: This method should <i>only</i> be used to free memory. Death 
