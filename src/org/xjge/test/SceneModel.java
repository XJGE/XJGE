...
public class SceneModel extends Scene {
    ...
    public void update(double targetDelta, double trueDelta) {
        for(var entity : queryEntities(ModelAnimator.class)) {
            ...
            if(entity.hasComponents(JointAttachment.class, Transform.class)) {
                ...
                entity.getComponent(JointAttachment.class).update(entity.getComponent(Transform.class), 
    ...
    private void outputModelData(Model model) {
        ...
        for(var bone : model.getSkeleton().getBones()) {
            System.out.println("  " + bone.getName() + " (" + model.getSkeleton().getBoneIndex(bone.getName()) + ")");
        }
        System.out.println();
    }
