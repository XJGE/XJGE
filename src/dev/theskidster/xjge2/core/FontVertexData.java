...
/**
 * Contains the vertex data used to render the {@link Glyph} instances generated by a {@link Font}.
 */
final class FontVertexData {
    ...
    /**
     * Uses the metrics of the provided font object to generate mesh data that will be shared between all {@link Glyph} instances.
     * 
    ...
    /**
     * Offsets the position of each glyph in the string according to its individual spacing requirements.
     * 
    ...
    /**
     * Offsets the texture coordinates of each glyph in the string to their corresponding cells (or sub-images) as they appear
     * in the bitmap image of the font provided.
     * 
    ...
    /**
     * Renders a string of text according to the glyph metrics of the font provided.
     * 
     * @param font    the font the text will be drawn in
     * @param glyphs  the collection of glyphs that comprise the string being drawn
