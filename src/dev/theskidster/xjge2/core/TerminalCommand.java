...
public abstract class TerminalCommand {
    ...
    /**
     * Creates a new terminal command with metadata that the {@linkplain TCHelp help command} will display.
     * <br><br>
     ...
     * <tr><td>&lt;type&gt;</td><td>An argument that should be replaced with an appropriate value of the specified data type.</td></tr>
     * <tr><td>[entry]</td><td>This entry is optional.</td></tr>
     * <tr><td>(entry|entry)</td><td>(Required) Pick one of the entries that are shown.</td></tr>
     * <tr><td>[entry|entry]</td><td>(Optional) Pick one of the entries that are shown.</td></tr>
     * </table>
     * 
    ...
    /**
     * Executes the command and creates an output string indicating its success or failure. Values parsed from the arguments passed by the 
     * command terminal must be validated individually by subclasses that contain this method.
     * 
    ...
    /**
     * Obtains the output object generated by the command that will be displayed to the user after it is executed.
     * 
     * @return an object that can be used by the terminal to format command output information
     */
    ...
    /**
     * Obtains a copy of a collection of every command the terminal will support. This is used by the engine by commands like 
    ...
    /**
     * Provides a generic response for "setter" style commands with a similar signature. Commands are considered "setter" style if they 
     * can be used to iterate and apply changes through some collection.
     * 
    ...
    /**
     * Provides a generic response for "showing" style commands with a similar signature. Commands are considered "showing" style if they 
     * control some boolean value.
     * 
     * @param diff the small difference used to better contextualize the response
     * 
     * @return the generated message as a string
     ...
     * 
     * @return an error message as a string that can be passed to {@link setOutput setOutput()}
     */
    ...
    /**
     * Provides a generic response for when users supply an argument to a command which cannot be processed either due to differing data 
     * types or a syntax error.
     * 
