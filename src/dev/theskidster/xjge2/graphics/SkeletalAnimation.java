...
class SkeletalAnimation {
     ...
     * @param frames      a collection of every {@link KeyFrame KeyFrame} that 
     *                    will be used by this animation
     */
     ...
     * @param frames   the keyframes automatically generated by the 
     *                 {@link Model} class
     */
     ...
     * animation.
     * 
     * @param aiName the unaltered name of the model as it appears in the model 
     *               file data
     * 
     * @return a human-readable string which can be used to identify the 
     *         animation
     */
     ...
     * 
     * @param index the location in the collection to store this transformation 
     *              at
     * 
