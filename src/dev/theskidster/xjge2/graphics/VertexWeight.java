...
/**
 * Data structure that represents a vertex weight that will determine how much influence a {@link Bone} has on the vertices of a 
 * {@link Mesh}. Typically multiple weights will influence a single vertex to an extent.
 */
class VertexWeight {
