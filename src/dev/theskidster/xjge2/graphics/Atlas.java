...
/**
 * Represents a texture atlas (or sprite sheet) that will provide the texture coordinates of sub-images within a larger 
 * {@link Texture}.
 * <br><br>
 ...
 * <li>A {@linkplain subImageOffsets collection} containing the texture coordinates of every sub-image cell.</li>
 * </ul>
 */
public final class Atlas {
    ...
    /**
     * The size (in texture coordinates) of a single sub-image cell. This information is useful in the event the atlas is used in a 
     * {@link SpriteAnimation} where consecutive frames are placed next to one another.
     */
